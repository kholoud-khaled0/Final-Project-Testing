...
public class RegisterWhileCheckout extends TestBase {
    ...
    RegisterWhileCheckoutPage  WhileCheckoutObject = new RegisterWhileCheckoutPage(driver);
  ...
  public void registerWhileCheckout(String name, String email, String password, int day, String month, 
      ...
      WhileCheckoutObject.Register_Login();
